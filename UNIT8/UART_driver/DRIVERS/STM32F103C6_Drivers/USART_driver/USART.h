...
typedef struct
{
	...
	uint32_t BAUD_RATE;
	//TO SPECIFY THE BAUD RATE OT THE TRANSMISSION.
	//THIS PARAMETER MUST BE SET BASED ON //@REF BAUD_RATE_define.

	uint8_t USART_MODE;
	//TO SPECIFY THE MODE OT THE USART.
	//THIS PARAMETER MUST BE SET BASED ON //@REF USART_MODE_define.

	uint8_t FLOW_CONTROL;
	//TO ENABLE AND DISABLE THE FLOW CONTROL OT THE USART.
	//THIS PARAMETER MUST BE SET BASED ON //@REF FLOW_CONTROL_define.

	uint8_t POLLING;
	//TO SELECT BETWEEN POLLING AND INTERRUPT.
	//THIS PARAMETER MUST BE SET BASED ON //@REF POLLING_define.

	uint8_t UART_IRQ;
	//TO ENABLE AND DISABLE THE INTERRUPTS OT THE USART.
...
//@REF POLLING_define:
#define POLING_DISABLE					0
#define POLING_ENABLE					1
